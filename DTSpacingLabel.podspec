#
#  Be sure to run `pod spec lint DTSpacingLabel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Dante"
  # s.authors            = { "Dante" => "elvewyn@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/Dante-Edge/DTSpacingLabel.git", :tag => "0.0.1" }
